class EnemyManager {
    ...
    getRandomItemNameWithCategoryFromItems(tier) {
        ...
        let randomItemNumb = Math.floor(Math.random()*allItems[this.getItemCategoryFromIndex(randomCategoryNumb)].length);
        return this.getItemCategoryFromIndex(randomCategoryNumb) + ":" + allItems[this.getItemCategoryFromIndex(randomCategoryNumb)][randomItemNumb];
    }

    getItemCategoryFromIndex(index){
        switch (index){
            case 0:
                return "weapon";
            case 1:
